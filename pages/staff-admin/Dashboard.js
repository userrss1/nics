          ...
          <div className="card">
            <div className="card-header p-3 pt-2">
              ...
              <div className="text-end pt-1">
                <b className="text-sm mb-0 text-capitalize">NO OF ASSIGNED CLIENTS</b>
        ...
        <div className="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div className="card">
            <div className="card-header p-3 pt-2">
              ...
              <div className="text-end pt-1">
                <b className="text-sm mb-0 text-capitalize">NO. OF PENDING ASSIGNED WORK</b>
      ...
      <div className="col-xl-4 col-sm-6 mb-xl-0 mb-4">
          <div className="card">
            <div className="card-header p-3 pt-2">
              ...
              <div className="text-end pt-1">
                <b className="text-sm mb-0 text-capitalize">NO OF PENDING WORK</b>
                    ...
                    <tr className="text-center">
                      <td>
                        <div className="d-flex px-2 py-1">
                          <div>
                            <a href="CA's.html"><img src="/staff-admin/img/team-2.jpg" className="avatar avatar-sm me-3 border-radius-lg" alt="CA1"/></a>
                          </div>
