...
<body className="g-sidenav-show  bg-gray-200">
    ...
    <div className="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul className="navbar-nav">
        ...
        <li className="nav-item mt-3">
          <a href="/staff-admin/client-list"><h6 className="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">ASSIGNED CLIENTS</h6></a>
        </li>
        <li className="nav-item mt-3">
  ...
  <main className="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
    ...
    <div className="container-fluid py-4">
          ...
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h6 className="text-white text-capitalize ps-3">CLIENTS WITH ASSIGNED WORK</h6>
              </div>
            </div>
                ...
                <table className="table align-items-center mb-0">
                  <thead>
                    <tr className="text-center">
                      ...
                      <th className="text-center text-uppercase text-secondary text-xl font-weight-bolder">WORK ASSIGNED</th>
                      <th className="text-center text-uppercase text-secondary text-xl font-weight-bolder">ACTION</th>
                      <th className="text-center text-uppercase text-secondary text-xl font-weight-bolder">WORK COMPLETED</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="text-center">
                      <td>
                        ...
                        <td>
                          <div className="container mt-3">
                            ...
                            <FontAwesomeIcon icon={faCheckSquare}  style={{ fontSize: 100, color: "white",height: "15px",padding:'7px 3px'}} />
                            </button>
                            <button type="button" className="btn btn-danger" data-bs-toggle="modal" data-bs-target="#">
                            <FontAwesomeIcon icon={faTimesCircle}  style={{ fontSize: 100, color: "white",height: "15px",padding:'7px 3px'}} />
                            </button>
                          </div>
                        </td>
                        <td>
                            <p className="text-xs font-weight-bold mb-0">Check box</p>
                        </td>
                    </tr>
                  </tbody>
                </table>
      ...
      <div className="row">
        <div className="col-12">
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h6 className="text-white text-capitalize ps-3">COMPLETED WORK</h6>
              </div>
            </div>
            <div className="card-body px-0 pb-2">
              <div className="table-responsive p-0">
      ...
      <h6 className="font-weight-bolder mb-0">AFTER WORK IS UNMARKED AS COMPLETED IT SHOULD BE AUTOMATICALLY REMOVED FROM THE LIST AND MOVE TO ASSIGN WORK</h6>
    </div>
            ...
            <div className="col-lg-6 mb-lg-0 mb-4">
              <div className="copyright text-center text-sm text-muted text-lg-start">
                © <script>
                 ...
                 <FontAwesomeIcon icon={faHeart}  style={{ fontSize: 100, color: "grey",height: "14px",padding:'9px 3px'}} />
