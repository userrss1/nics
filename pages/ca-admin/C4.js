          ...
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h6 className="text-white text-center text-capitalize ps-3 px-6">Clients who have approved our request</h6>
                      ...
                      <td>
                        ...
                        <td className="align-middle text-center text-sm">
                          <div className="container mt-3">
                            ...
                            <FontAwesomeIcon icon={faTrash}  style={{ fontSize: 100, color: "white",height: "17px",padding:'0px 3px'}} />
                            </button>
                          </div>
                       </td>
                    </tr>
