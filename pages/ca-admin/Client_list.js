...
export default function Client_list(props) {
  return (
   <>
     <Head>
  <meta charset="utf-8" />
          ...
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h6 className="text-white text-center text-capitalize ps-3 px-6">List of clients and user adins</h6>
                      ...
                      <td>
                        ...
                        <td className="align-middle text-center text-sm">
                          <div className="container mt-3">
                            {/* <button type="button" className="btn bg-gradient-warning" data-toggle="modal" data-target="#myModal2" style={{width:'150px'}}>My space</button>
                            <button type="button" className="btn bg-gradient-info" data-toggle="modal" data-target="#myModal">
                             Client space
                            </button> */}
                            <Link href="/ca-admin/MySpace"><a><button type="button" className="btn bg-gradient-info">My space</button></a></Link>&nbsp;
                            <Link href=""><a><button type="button" className="btn bg-gradient-success">User space</button></a></Link>
                          </div>
                        </td>
                    </tr>
                  </tbody>
          ...
          <div className="row align-items-center justify-content-lg-between">
            <div className="col-lg-6 mb-lg-0 mb-4">
              <div className="copyright text-center text-sm text-muted text-lg-start">
                ...
                <FontAwesomeIcon icon={faHeart}  style={{ fontSize: 100, color: "grey",height: "15px",padding:'9px 3px'}} />
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-header">
        <h4 className="modal-title w3-text-pink">My Space</h4>
          <button type="button" className="btn bg-gradient-info" style={{width:'150px'}}>Request to another user</button>
          <button type="button" className="btn btn-danger" data-dismiss="modal"> <FontAwesomeIcon icon={faWindowClose}  style={{ fontSize: 100, color: "white",height: "15px",padding:'9px 3px'}} /></button>
              ...
              <td>
                <input type="file"/>
                 ...
                 <td></td>
                    ...
                    <Link href="#"><a><button type="button" className="btn btn-info">
                         Move
                     </button>
                     </a></Link>
                    </div>
...
<div className="modal" id="myModal">
  <div className="modal-dialog" >
    <div className="modal-content">
      ...
      <div className="modal-header">
        <h4 className="modal-title w3-text-pink">Client Space</h4>
          <button type="button" className="btn bg-gradient-info" style={{width:'150px'}}>Request to another user</button>
          <button type="button" className="btn btn-danger" data-bs-dismiss="modal"> <FontAwesomeIcon icon={faWindowClose}  style={{ fontSize: 100, color: "white",height: "15px",padding:'9px 3px'}} /></button>
      </div>
              ...
              <tbody>
                  <tr className="text-center">
                     ...
                     <td></td>
                        ...
                        <td className="align-middle text-center text-sm">
                          <div className="container mt-3">
                            <Link href="#"><a><button type="button" className="btn btn-success">
                              Edit
                            </button>
                              </a></Link>
                              <Link href="#"><a><button type="button" className="btn btn-danger">
                              Delete
                            </button>
                          </a></Link>
                          </div>
                    ...
                    <tr className="text-center">
                     ...
                     <td>FILES TO BE UPLOADED FOR User</td>
                     <td></td>
