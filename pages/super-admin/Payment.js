      ...
      <body className="g-sidenav-show  bg-gray-200">
        <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
                  ...
                  <li style={{ display: 'flex', width: '100%', justifyContent: 'left', alignItems: 'center' }}>
                    <AccordionDetails style={{ padding: '0px' }}>
                      <a className="nav-link text-white " href="/super-admin/Registeredca" style={{ display: 'inline-block' }}>
                        <span className={styles.pack} style={{ display: 'inline-block' }}><FontAwesomeIcon icon={faPlus} style={{ fontSize: 100, color: "white", height: "15px", padding: '7px 3px' }} />Registered users</span>
                      </a>
                    </AccordionDetails>
                  </li>
                  <li style={{ width: '100%', display: 'flex', justifyContent: 'left', alignItems: 'center' }}>
                    <AccordionDetails style={{ padding: '0px' }}>
                      <a className="nav-link text-white " href="/super-admin/New_reg" style={{ display: 'inline-block' }}>
                        <span className={styles.pack} style={{ display: 'inline-block' }}><FontAwesomeIcon icon={faEye} style={{ fontSize: 100, color: "white", height: "15px", padding: '7px 3px' }} />Pending Approvals</span>
                      </a>
                    </AccordionDetails>
                  </li>
                </ul>
                    ...
                    <li style={{ display: 'flex', width: '100%', justifyContent: 'left', alignItems: 'center' }}>
                      <AccordionDetails style={{ padding: '0px' }}>
                        <a className="nav-link text-white " href="/super-admin/Addpackage" style={{ display: 'inline-block' }}>
                          <span className={styles.pack} style={{ display: 'inline-block' }}><FontAwesomeIcon icon={faPlus} style={{ fontSize: 100, color: "white", height: "15px", padding: '7px 3px' }} />Add Packages</span>
                        </a>
                      </AccordionDetails>
                    </li>
                    <li style={{ width: '100%', display: 'flex', justifyContent: 'left', alignItems: 'center' }}>
                      <AccordionDetails style={{ padding: '0px' }}>
                        <a className="nav-link text-white " href="/super-admin/Packages" style={{ display: 'inline-block' }}>
                          <span className={styles.pack} style={{ display: 'inline-block' }}><FontAwesomeIcon icon={faEye} style={{ fontSize: 100, color: "white", height: "15px", padding: '7px 3px' }} />View</span>
                        </a>
                      </AccordionDetails>
                    </li>
                  </ul>
                  ...
                  <li style={{ display: 'flex', width: '100%', justifyContent: 'left', alignItems: 'center' }}>
                    <AccordionDetails style={{ padding: '0px' }}>
                      <a className="nav-link text-white " href="/super-admin/Planexpiring" style={{ display: 'inline-block' }}>
                        <span className={styles.pack} style={{ display: 'inline-block' }}><FontAwesomeIcon icon={faPlus} style={{ fontSize: 100, color: "white", height: "15px", padding: '7px 3px' }} />Plan Expriring</span>
                      </a>
                    </AccordionDetails>
                  </li>
                  <li style={{ width: '100%', display: 'flex', justifyContent: 'left', alignItems: 'center' }}>
                    <AccordionDetails style={{ padding: '0px' }}>
                      <a className="nav-link text-white " href="/super-admin/Payment" style={{ display: 'inline-block' }}>
                        <span className={styles.pack} style={{ display: 'inline-block' }}><FontAwesomeIcon icon={faEye} style={{ fontSize: 100, color: "white", height: "15px", padding: '7px 3px' }} />Payment Recieved</span>
                      </a>
                    </AccordionDetails>
                  </li>
                </ul>
          ...
          <li className="nav-item mt-3">
                <a href="/super-admin/Adminstaff"><h6 className="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">SUPER ADMIN STAFF</h6></a>
              </li>
              <li className="nav-item mt-3">
                <a href="/super-admin/Contactmsg"><h6 className="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">CONTACT MESSAGES</h6></a>
              </li>
              <li className="nav-item mt-3">
                <a href="/super-admin/Complaints"><h6 className="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">COMPLAINTS</h6></a>
              </li>
              <li className="nav-item mt-3">
                <a href="/super-admin/Addorganisation"><h6 className="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">ADD ORGANISATION</h6></a>
              </li>
        </aside>
          ...
          <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div className="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                <h6 className="font-weight-bolder mb-0">Payments</h6>
              </nav>
              <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul className="navbar-nav  justify-content-end">
                  <li className="nav-item d-flex align-items-center">
                    <a href="/super-admin/Sign-in" className="nav-link text-body font-weight-bold px-0">
                ...
                <div className="card my-4">
                  <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                      <h6 className="text-white text-capitalize ps-3">Registered Users</h6>
                    </div>
                  </div>
                      ...
                      <table className="table align-items-center mb-0">
                        <thead>
                          <tr className="text-center">
                            <th className="text-uppercase text-secondary text-xl font-weight-bolder">Name</th>
                            <th className="text-uppercase text-secondary text-xl font-weight-bolder ps-2">Mobile No.</th>
                            <th className="text-uppercase text-secondary text-xl font-weight-bolder ps-2">Amount</th>
                            <th className="text-uppercase text-secondary text-xl font-weight-bolder ps-2">Payment Method</th>
                          ...
                          <tr className="text-center">
                            <td>
                              <div className="d-flex px-2 py-1">
                                <div>
                                  <a href="users.html"><img src="/super-admin/img/team-2.jpg" className="avatar avatar-sm me-3 border-radius-lg" alt="user1" /></a>
                                </div>
                            ...
                            <td>
                              <p className="text-xs font-weight-bold mb-0">100/-</p>
                            </td>
                            <td>
                              <p className="text-xs font-weight-bold mb-0"><img src="C:\xampp\htdocs\Dashboard_Project\material-dashboard-2\assets\img\logos\visa.png" className="image-fluid" /></p>
                            </td>
                            <td className="align-middle text-center text-sm">
                              ...
                              <div className="container mt-3">
                                ...
                                <button type="button" className="btn btn-default" data-bs-toggle="modal" data-bs-target="#myModal1">
                                  Offline
                                </button>
                              </div>
                            </td>
                          ...
                          <div className="modal-dialog">
                            <div className="modal-content">
                              ...
                              <div className="container w3-sans-serif">
                                <h3 className="w3-text-red">Add new</h3>
