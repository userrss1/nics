...
myHeaders.append( "Authorization", `Bearer ${access_token}`);
  const res = await fetch(BASE_URL +`/sa/contact_us_detials/`, { headers:  myHeaders });
...
export default function Contactmsg({data}) {
  console.log("contact")
  console.log(data)
  return (
   <>
    ...
    <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div className="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 className="font-weight-bolder mb-0">Contact</h6>
        </nav>
          ...
          <div className="card my-4">
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <h2 className="text-white text-center text-capitalize ps-3 px-6">Messages</h2>
            ...
            <div className="card-body px-0 pb-2">
              <div className="table-responsive p-0">
                <table className="table align-items-center mb-0">
                  ...
                  {data.map((o,i) => {
                  return (
                    <tr className="text-center" key={o.id}>
                      <td>
                        ...
                        <td>
                          <div className="d-flex px-2 py-1">
                            ...
                            <div className="d-flex flex-column justify-content-center">
                              <h6 className="mb-0 text-bold">{o.name}</h6>
                        ...
                        <td>
                          ...
                          <td>
                            <p className="text-xs font-weight-bold mb-0">Open</p>
                        </td>
                          
                                 <td className="align-middle text-center text-sm">
                                    <div className="container mt-3">
                                      <button type="button" className="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#myModal"> <FontAwesomeIcon icon={faEye}  style={{ fontSize: 100, color: "white",height: "17px",padding:'0px 3px'}} /></button>
                                    </div>
                                 </td>
                        </tr>
             )})}
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-header">
        <h4 className="modal-title w3-text-pink">Contact</h4>
        ...
        <form>
          <div className="row">
           ...
           <div className="form-group">
             ...
             <textarea type="text" className="form-control" id="name" placeholder="Your message" name="message" required></textarea>
           </div>
           <div className="form-group">
             <label htmlFor="name"> Response*:</label>
             <textarea type="text" className="form-control" id="name" placeholder="Your response" name="message" required></textarea>
            </div>
           </div>
           <div className="col-lg-12">
           <div className="form-group">
             <label htmlFor="email">Super Admin Staff ID:</label>
             <input type="text" className="form-control" id="email" placeholder="Enter id" name="email" required/>
           </div>
           </div>
