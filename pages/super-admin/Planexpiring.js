...
export default function Planexpiring() {
  return (
    <>
      <Head>
  <meta charSet="utf-8" />
            ...
            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                <div className="container">
                  <h2 className="text-white text-center text-capitalize ps-3 px-6">Plan Expriring</h2>
                ...
                <table className="table align-items-center mb-0">
                  <thead>
                    <tr className="text-center">
                      ...
                      <th className="text-center text-uppercase text-secondary text-xl font-weight-bolder">CURRENT PLAN</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="text-center">
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-header">
        <h4 className="modal-title w3-text-pink">Add staff</h4>
        ...
        <form>
          <div className="row">
           ...
           <div className="form-group">
             ...
             <input type="text" className="form-control" id="name" placeholder="Enter first name" name="email"/>
           </div>
           <div className="form-group">
             <label htmlFor="name"> Last Name:</label>
             <input type="text" className="form-control" id="name" placeholder="Enter last name" name="email"/>
           </div>
           </div>
           <div className="col-lg-12">
           <div className="form-group">
           ...
           <div className="form-group">
             ...
             <input type="tel" className="form-control" id="mobile" placeholder="Enter mobile no." name="email"/>
           </div>
           <div className="form-group">
             <label htmlFor="contact">Designation:</label>
             <input type="text" className="form-control" id="mobile" placeholder="Enter your designation" name="email"/>
           </div>
           <div className="form-group">
...
<div className="modal" id="myModal">
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-header">
        <h4 className="modal-title w3-text-pink">WORK TO BE ASSIGNED</h4>
        ...
        <form>
          <div className="row">
           ...
           <div className="form-group">
            ...
            <label htmlFor="vehicle1"> REGISTRATION</label><br/>
           </div>
           <div className="form-group">
            <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"/>
            <label htmlFor="vehicle1"> COMPLAINTS</label><br/>
           </div>
           </div>
           <div className="col-lg-12">
           <div className="form-group">
            <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"/>
            <label htmlFor="vehicle1"> PACKAGES & COMPLAINTS</label><br/>
           </div>
           </div>
           <div className="col-lg-12">
           <div className="form-group">
            <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"/>
            <label htmlFor="vehicle1"> PAYMENT STATUS</label><br/>
           </div>
