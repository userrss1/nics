                  ...
                  <div className="row">
                   ...
                   <div className="row">
                    ...
                    <center><p className="mb-2 text-sm mx-auto py-2">
                      ...
                      <a href="/super-admin/sign-in" className="text-info text-gradient font-weight-bold">Sign in</a>
                    </p></center>
                  </div> */}
                  <div style={{overflow:'auto'}}>
                    <div style={{float:'right'}}>
                      {/* <button type="button" id="prevBtn" onclick="nextPrev(-1)" className="btn btn-md font-weight-bolder bg-gradient-info w-42 mt-2 mb-0">Previous</button> */}
                      <button type="button" id="nextBtn" onClick="nextPrev(1)" className="btn btn-md font-weight-bolder bg-gradient-info w-42 mt-2 mb-0">Next</button>
                    </div>
                  </div>
        ...
        <div className="col-sm-12 col-md-8 col-lg-6 mx-auto my-auto">
          <div className="card z-index-0 fadeIn3 fadeInBottom">
            <div className="card-body">
              ...
              <Carousel>
                  <div>
                      <img src="/super-admin/img/advertisement.jpg" alt="image1"/>
                      
  
                  </div>
                  <div>
                      <img src="/super-admin/img/advertisement1.jpg" alt="image2" />
                    
  
                  </div>
                  <div>
                      <img src="/super-admin/img/advertisement2.jpg" alt="image3"/>
