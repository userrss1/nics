...
export default function Adminstaff({token1, BASE_URL}) {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(first_name,last_name,mobile,email,designation,profile_image)
    console.log(token1)
  ...
  async function addedpack() {
    ...
    formdata.append("profile_image", fileInput.files[0], `${profile_image}`);var requestOptions = {
      ...
      body: formdata,
      redirect: 'follow'
    };fetch(BASE_URL +"/sa/add_staff/?&first_name="+`${first_name}`+"&last_name="+`${last_name}`+"&mobile="+`${mobile}`+"&email="+`${email}`+"&designation="+`${designation}`, requestOptions)
          ...
          <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div className="container-fluid py-1 px-3">
              <nav aria-label="breadcrumb">
                <h6 className="font-weight-bolder mb-0">Super admin staff</h6>
              </nav>
                ...
                <div className="card my-4">
                  <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div className="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3">
                      <button type="button" className="btn bg-gradient-success w3-margin text-center" data-toggle="modal" data-target="#myModal2"><FontAwesomeIcon icon={faPlusSquare} style={{ fontSize: 100, color: "white", height: "17px", padding: '0px 3px' }} /> <span className="text-white text-center text-capitalize ps-3"> Add Staff</span></button>
                      <h2 className="text-white text-center text-capitalize ps-3 px-6">Super Admin Staff</h2>
                      <form className="form-inline d-flex justify-content-center md-form form-sm mt-0">
                        <input className="form-control text-center form-control-sm ml-3 w-25" type="text" placeholder="Search"
                          aria-label="Search" />
                        <h4 className="px-4 text-white"><FontAwesomeIcon icon={faSearch} style={{ fontSize: 100, color: "white", height: "25px", padding: '0px 3px' }} /></h4>
                      </form>
                    </div>
                  </div>
                      ...
                      <table className="table align-items-center mb-0">
                        ...
                        <tbody>
                          <tr className="text-center">
                            ...
                            <td>
                              <p className="text-xs font-weight-bold mb-0">12 P.M.</p>
                            </td>
                            <td>
                              <p className="text-xs font-weight-bold mb-0">12 P.M.</p>
                            </td>
  ...
  <Script src="../assets/js/material-dashboard.min.js?v=3.0.0"></Script>
    ...
    function myFunction(id) {
      ...
      <div className="modal" id="myModal2">
        ...
        <h3 className="modal-title text-white ">Add Staff</h3>
            ...
            <div className="modal-body">
              <div className="container w3-sans-serif" onSubmit={handleSubmit}>
