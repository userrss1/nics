! function(t, e) {
  ...
  var t = {},
    ...
    s = function(e, i, s) {
      var a = i.split(":")[1];
      e.removeEventListener(a, s), <i className="fa fa-trash" aria-hidden="true"></i> t[i]
    },
    a = function() {
      return t
    },
    ...
    z = function() {
      ...
      return e.init = function(t) {
        ...
        t || (t = Object.keys(this.markers)), t.forEach((function(t) {
          e.markers[t].element.remove(), <i className="fa fa-trash" aria-hidden="true"></i> e.markers[t]
        }))
        ...
        f.removeElement(r), n(i).forEach((function(t) {
          ...
          try {
            <i className="fa fa-trash" aria-hidden="true"></i> e[t]
          } catch (t) {}
        }))
